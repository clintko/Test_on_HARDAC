...
namespace schools_model_namespace {
...
{" (found before start of program)",
 " (in '/gpfs/fs1/data/reddylab/Kuei/learn/learn_stan/ex_school/schools.stan', line 7, column 4 to column 12)",
 " (in '/gpfs/fs1/data/reddylab/Kuei/learn/learn_stan/ex_school/schools.stan', line 8, column 4 to column 22)",
 " (in '/gpfs/fs1/data/reddylab/Kuei/learn/learn_stan/ex_school/schools.stan', line 9, column 4 to column 18)",
 " (in '/gpfs/fs1/data/reddylab/Kuei/learn/learn_stan/ex_school/schools.stan', line 12, column 4 to column 37)",
 " (in '/gpfs/fs1/data/reddylab/Kuei/learn/learn_stan/ex_school/schools.stan', line 15, column 4 to column 38)",
 " (in '/gpfs/fs1/data/reddylab/Kuei/learn/learn_stan/ex_school/schools.stan', line 16, column 4 to column 44)",
 " (in '/gpfs/fs1/data/reddylab/Kuei/learn/learn_stan/ex_school/schools.stan', line 2, column 4 to column 19)",
 " (in '/gpfs/fs1/data/reddylab/Kuei/learn/learn_stan/ex_school/schools.stan', line 3, column 11 to column 12)",
 " (in '/gpfs/fs1/data/reddylab/Kuei/learn/learn_stan/ex_school/schools.stan', line 3, column 4 to column 14)",
 " (in '/gpfs/fs1/data/reddylab/Kuei/learn/learn_stan/ex_school/schools.stan', line 4, column 24 to column 25)",
 " (in '/gpfs/fs1/data/reddylab/Kuei/learn/learn_stan/ex_school/schools.stan', line 4, column 4 to column 27)",
 " (in '/gpfs/fs1/data/reddylab/Kuei/learn/learn_stan/ex_school/schools.stan', line 9, column 11 to column 12)",
 " (in '/gpfs/fs1/data/reddylab/Kuei/learn/learn_stan/ex_school/schools.stan', line 12, column 11 to column 12)"};



class schools_model final : public model_base_crtp<schools_model> {
 ...
 public:
  ...
  inline std::string model_name() const final { return "schools_model"; }
  ...
  schools_model(stan::io::var_context& context__,
    ...
    static constexpr const char* function__ = "schools_model_namespace::schools_model";
  ...
  inline stan::scalar_type_t<VecR> log_prob_impl(VecR& params_r__,
    ...
    local_scalar_t__ DUMMY_VAR__(std::numeric_limits<double>::quiet_NaN());
    (void) DUMMY_VAR__;  // suppress unused var warning
    static constexpr const char* function__ = "schools_model_namespace::log_prob";
    (void) function__;  // suppress unused var warning
    ...
    try {
      ...
      assign(theta, add(mu, multiply(tau, eta)), "assigning variable theta");
      {
        ...
        lp_accum__.add(normal_lpdf<false>(y, theta, sigma));
      }
    } catch (const std::exception& e) {
      stan::lang::rethrow_located(e, locations_array__[current_statement__]);
      // Next line prevents compiler griping about no return
  ...
  inline void write_array_impl(RNG& base_rng__, VecR& params_r__,
    ...
    (void) DUMMY_VAR__;  // suppress unused var warning
    static constexpr const char* function__ = "schools_model_namespace::write_array";
    (void) function__;  // suppress unused var warning
...
using stan_model = schools_model_namespace::schools_model;
...
stan::math::profile_map& get_stan_profile_data() {
  return schools_model_namespace::profiles__;
}
